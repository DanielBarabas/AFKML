...
time.sleep(5)
tests.update_agrid(driver,5,1)
time.sleep(5)
tests.update_agrid(driver,10,1)
time.sleep(5)
tests.update_agrid(driver,5,0)
time.sleep(5)
tests.update_agrid(driver,10,0)
...
print(len(toggles))
time.sleep(1)
tests.test_scroll_to_element(driver=driver, elem=h2s[4])
time.sleep(2)
toggles = tests.find_toggles(driver=driver)
time.sleep(2)
...
for i in range(len(h2s)):
    ...
    body.send_keys(Keys.PAGE_DOWN)
    body.send_keys(5*Keys.ARROW_UP)
body.send_keys(Keys.PAGE_DOWN)
body.send_keys(5*Keys.ARROW_UP)
time.sleep(100)
